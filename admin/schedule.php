...
<body>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <td style="text-align:center;">
                                            '.substr($scheduledate,0,10).' '.date("h:i A", strtotime($scheduletime)).'
                                        </td>
                                        <td style="text-align:center;">
                                            '.$nop.'
                                        </td>
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            $sqlmain12= "select * from appointment inner join patient on patient.pid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where appointment.appostatus = '1' AND schedule.scheduleid=$id;";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Patients that already accepted their appointment:</b> ('.$result12->num_rows."/".$nop.')</label>
                                    <br><br>
                                </td>
                            </tr>
