 ...
 <div class="container">
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $sqlmain12= "select * from appointment inner join patient on patient.pid=appointment.pid inner join schedule on schedule.scheduleid where appointment.appostatus = '1' AND schedule.scheduleid=$id;";
