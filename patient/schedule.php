                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br><br><br><br>
                                     ...
                                     $sqlretrieve= "select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate,appointment.appostatus from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid where  patient.pid=$userid ";
                                    $sqlretrieve.="order by appointment.appodate  asc";
                                    $retrieveresult= $database->query($sqlretrieve);
                                    if ($retrieveresult->num_rows == 0) {
                                        // if no result from the retriveresult execute this but if has result do not
                                                ...
                                                <td style="width: 25%;">
                                                        <div  class="dashboard-items search-items"  >
                                                            ...
                                                            <div style="width:100%">
                                                                    ...
                                                                    <div class="h4-search">
                                                                   ' . date("F j, Y", strtotime($scheduledate)) .' <br>Starts: <b>@'.date("h:i A", strtotime($scheduletime)).'</b> 
                                                                    </div>
                                                                    <br>
