...
<body>
    ...
    <div class="container">
        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-">
                        <a href="chatbot.php" class="non-style-link-menu"><div><p class="menu-text">Chatbot</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-">
                                    ...
                                    for ( $x=0; $x<($result->num_rows);$x++){
                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div style="width:100%;">
                                                        <div class="h3-search">
                                                        <h2>Appointment Date: '.substr($appodate,0,30).'</h2>
                                                    ...
                                                    <div id="popup1" class="overlay" style="display: none;">
                                                        <div class="popup">
                                                            <center>
                                                                ...
                                                                <div class="content">
                                                                    Please check your appointment schedule.<br>
                                                                    Thank you!
                                                                </div>
                                                                <div style="display: flex; justify-content: center;">
                                                                    <button id="popup-ok" class="btn-primary btn" style="margin:10px;padding:10px;">
                                                                        &nbsp;&nbsp;Ok&nbsp;&nbsp;
                                                                    </button>
                                                                </div>
                                                            </center>
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <h2>Wait for the Approval!</h2>
                                                                ...
                                                                <div class="h4-search">
                                                                    Scheduled Date: ' . date("F j, Y", strtotime($scheduledate)) .'<br>Starts: <b>@'.date("h:i A", strtotime($scheduletime)).'</b> 
                                                                </div>
                                                                <br>
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%;">
                                                    <div class="h3-search">
                                                                Booking Date: ' . date("F j, Y", strtotime($appodate)) .'<br>
                                                                Reference Number: OC-000-'.$appoid.'
                                                            </div>
                                                            <div class="h1-search">
                                                                '.substr($title,0,21).'<br>
                                            ...
                                            <div id="popup1" class="overlay" style="display: block;">
                                                <div class="popup">
                                                    <center>
                                                        <h2>Sorry! your appointment has been canceled!</h2>
                                                        <div class="content">
                                                            *You didn\'t attend the dental education.<br>
                                                        </div>
                                                        <div style="display: flex; justify-content: center;">
                                                            <button id="popup-ok" class="btn-primary btn" style="margin:10px;padding:10px;">
                                                                &nbsp;&nbsp;Ok&nbsp;&nbsp;
    ...
    if($_GET){
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                    <br><br>
                        <h2>Booking Applied Successfully.</h2>
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                        Wait for the approval from the clinic.<br><br>
...
window.onbeforeunload = function () {
    sessionStorage.removeItem("popupSeen"); // reset every reload
};
...
window.onload = function () {
    ...
    var btn = document.getElementById("popup-ok");
    if (btn) {
