                ...
                <?php
                    if($_POST){
                        ...
                        if(!empty($_POST["docid"])){
                            $docid=$_POST["docid"];
                            $sqlpt2=" doctor.docid=$docid and appointment.appostatus = 2 order by schedule.scheduledate desc";
                        }
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        ...
                        $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate,appointment.appostatus from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid where appointment.appostatus = 2 order by schedule.scheduledate desc";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        <a href="?action=view&id='.$appoid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-accept"  style="padding-right: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Accept</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            You want to cancel the appointment:<br><br>
                            Patient Name: &nbsp;<b>'.substr($nameget,0,40).'</b><br>
                            Appointment number &nbsp; : <b>'.substr($apponum,0,40).'</b><br><br>
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="update-appointment.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
            ...
            $appoid=$_GET["id"];
            $sqlmain = "UPDATE appointment SET appostatus = 1 WHERE appoid = $id";
            $result = $database->query($sqlmain);
            ...
            echo '
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                            <br><br><br><br>
                                <h2>You accepted a booking Successfully!</h2>
                                <a class="close" href="appointment.php">&times;</a>
                                <div class="content">
